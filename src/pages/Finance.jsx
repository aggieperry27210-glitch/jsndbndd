...
import { TrendingUp, Trophy, ArrowRight, Loader2, Star, Award, Clock, CheckCircle2 } from "lucide-react";
...
export default function Finance() {
  ...
  const { data: quizzes, isLoading } = useQuery({
    ...
    queryFn: () => base44.entities.Quiz.filter({ category: 'finance' }),
    initialData: [],
  });
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-20 right-0 w-96 h-96 bg-purple-600/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-pink-600/10 rounded-full blur-3xl animate-pulse delay-700" />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600/10 via-pink-600/10 to-transparent rounded-3xl blur-2xl" />
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center lg:text-left">
                <motion.div
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-600/20 border border-purple-500/40 text-purple-300 text-sm font-semibold mb-6"
                >
                ...
                <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-2xl">
                  Build essential money skills through interactive quizzes. Learn budgeting, credit management, and investing to secure your financial future.
                </p>
              ...
              >
                <div className="w-48 h-48 sm:w-64 sm:h-64 relative">
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500 via-pink-500 to-rose-500 rounded-full opacity-20 blur-2xl animate-pulse" />
        ...
        >
          {[
            { emoji: "💰", title: "Budgeting Basics", desc: "Track income and expenses effectively", color: "from-purple-500 to-pink-500", path: createPageUrl("BudgetingBasics") },
            { emoji: "💳", title: "Credit & Debt", desc: "Understand credit scores and managing debt", color: "from-pink-500 to-rose-500", path: createPageUrl("CreditDebt") },
            { emoji: "📈", title: "Saving & Investing", desc: "Build wealth and plan for the future", color: "from-rose-500 to-orange-500", path: createPageUrl("SavingInvesting") }
          ].map((topic, index) => (
            <motion.div
              key={topic.title}
              initial={{ opacity: 0, y: 20 }}
                  ...
                  >
                    <Link to={`${createPageUrl("Quiz")}?id=${quiz.id}`}>
                      <div className="group relative h-full">
                        ...
                        <div className={`absolute -inset-0.5 ${isMastered ? 'bg-gradient-to-r from-yellow-600 to-orange-600' : 'bg-gradient-to-r from-purple-600 to-pink-600'} rounded-2xl blur-lg opacity-0 group-hover:opacity-40 transition-opacity duration-500`} />
                        ...
                        <div className="relative bg-slate-900/80 backdrop-blur-2xl border border-slate-800 rounded-2xl overflow-hidden h-full">
                          ...
                          <div className={`h-1.5 ${isMastered ? 'bg-gradient-to-r from-yellow-500 via-orange-500 to-red-500' : 'bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500'}`} />
                          ...
                          <div className="p-6">
                            ...
                            <div className="flex items-center justify-between pt-4 border-t border-slate-800">
                              ...
                              <div className="flex items-center gap-2 text-purple-400 font-bold group-hover:gap-3 transition-all duration-300">
